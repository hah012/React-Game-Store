...
const PAGE_SIZE = 25;
const MAX_PAGES = 2; // Set the maximum number of pages to fetch
    ...
    const fetchGames = async () => {
      try {
        ...
        const response = await fetch(
          `https://api.rawg.io/api/games?key=${API_KEY}&genres=massively-multiplayer&ordering=-popularity&page=${currentPage + 1}&page_size=${PAGE_SIZE}`
        );
