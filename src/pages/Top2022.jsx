    ...
    const fetchGames = async () => {
      try {
        ...
        const response = await fetch(
          `https://api.rawg.io/api/games?key=${API_KEY}&dates=2022-01-01,2022-12-31&ordering=-added&page=${currentPage}&page_size=${PAGE_SIZE}`
        );
